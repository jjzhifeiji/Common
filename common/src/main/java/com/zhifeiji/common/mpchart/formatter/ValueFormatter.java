package com.zhifeiji.common.mpchart.formatter;


import com.zhifeiji.common.mpchart.components.AxisBase;
import com.zhifeiji.common.mpchart.data.BarEntry;
import com.zhifeiji.common.mpchart.data.BubbleEntry;
import com.zhifeiji.common.mpchart.data.CandleEntry;
import com.zhifeiji.common.mpchart.data.Entry;
import com.zhifeiji.common.mpchart.data.PieEntry;
import com.zhifeiji.common.mpchart.data.RadarEntry;
...
public abstract class ValueFormatter implements IAxisValueFormatter, IValueFormatter{
     ...
     * @param stackedEntry stacked entry being labeled, contains all icon_Y values
     * @return formatted string label
     */
     ...
     *
     * @param entry point being labeled, contains icon_X value
     * @return formatted string label
     */
     ...
     * @param pieEntry slice being labeled, contains original, non-percentage icon_Y value
     * @return formatted string label
     */
     ...
     *
     * @param bubbleEntry bubble being labeled, also contains icon_X and icon_Y values
     * @return formatted string label
     */
